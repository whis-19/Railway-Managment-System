...
namespace GROUP_2
{
    public partial class psProfile : Form
    {
        ...
        private void update_Click(object sender, EventArgs e)
        {
            ...
            string query = $"UPDATE F223722.PASSENGER SET Name = '{Name}', Email = '{email}', Address = '{address}',PhoneNumber = '{phoneNumber}', Gender = '{gender}', CNIC = '{cnic}' WHERE EMAIL = '{email}'";
        ...
        private void psProfile_Load(object sender, EventArgs e)
        {
            if (accTF == "Passenger")
            {
                string query = $"SELECT * FROM F223722.PASSENGER WHERE EMAIL ='{emailCred}'";
